...
public class BPMNFormModelGeneratorImpl implements BPMNFormModelGenerator {
        ...
        if (dataOutputAssociations != null) {
            ...
            dataOutputAssociations.forEach(outputAssociation -> {
                if (outputAssociation.getSourceRef() != null &&
                        ...
                        !isMIOutputVariable(userTask, outputAssociation)) {
    ...
    private static boolean isMIOutputVariable(UserTask userTask, DataOutputAssociation outputAssociation) {
        MultiInstanceLoopCharacteristics loopCharacteristics = (MultiInstanceLoopCharacteristics) userTask.getLoopCharacteristics();
        String outputVariableId = loopCharacteristics != null ? getId(loopCharacteristics.getOutputDataItem()) : null;
        if (StringUtils.isEmpty(outputVariableId)) {
            return false;
        }
        String associationTargetRef = getId(outputAssociation.getTargetRef());
        return outputVariableId.equals(associationTargetRef);
    }
