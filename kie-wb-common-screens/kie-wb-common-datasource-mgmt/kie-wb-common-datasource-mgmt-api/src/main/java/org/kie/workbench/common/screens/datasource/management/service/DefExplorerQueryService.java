 ...
 * ProjectDataSourceExplorer and GlobalDataSourceExplore. The returned results are calculated by using the AuthorizationManager
 * and depends on current user.
 */
@Remote
