...
/**
 * Helper class used by the WildflyDataSourceProviderOLD to interact with the Wildfly server.
 */
@ApplicationScoped
public class DataSourceProviderHelper {
    ...
    public DataSourceDeploymentInfo deployDataSource( final DataSourceDef dataSourceDef, final String jndi, String deploymentId ) throws Exception {
        ...
        return new DataSourceDeploymentInfo( dataSourceDef.getName(), true, dataSourceDef.getUuid(), false );
    }
