...
public class WildflyDataSourceService
    ...
    public void deploy( final WildflyDataSourceDef dataSourceDef ) throws Exception {
        createDatasource( dataSourceDef.getName(),
    ...
    public List<WildflyDataSourceDef> getDeployedDataSources() throws Exception {
