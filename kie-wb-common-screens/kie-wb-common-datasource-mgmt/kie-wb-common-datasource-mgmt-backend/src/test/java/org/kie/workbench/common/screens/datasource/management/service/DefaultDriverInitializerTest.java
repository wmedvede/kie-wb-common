...
public class DefaultDriverInitializerTest {
    ...
    @Mock
    private DataSourceServicesHelper servicesHelper;
    ...
    @Before
    public void setup() {
        driverInitializer = new DefaultDriverInitializerImpl( ioService, servicesHelper, optionFactory );
    }

    public void testInitializeFromSystemProperties() {
