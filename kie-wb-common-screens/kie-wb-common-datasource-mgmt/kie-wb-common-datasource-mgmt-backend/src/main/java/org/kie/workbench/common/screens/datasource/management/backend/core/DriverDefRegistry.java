...
public interface DriverDefRegistry {
    ...
    DriverDefRegistryEntry registerDriverDef( DriverDef driverDef );

    void deRegisterDriverDef( String uuid ) throws Exception;

    DriverDefRegistryEntry getDriverDefEntry( String uuid );
     ...
     */
    List<DriverDefRegistryEntry> findReferencedEntries( String dataSourceUuid );
