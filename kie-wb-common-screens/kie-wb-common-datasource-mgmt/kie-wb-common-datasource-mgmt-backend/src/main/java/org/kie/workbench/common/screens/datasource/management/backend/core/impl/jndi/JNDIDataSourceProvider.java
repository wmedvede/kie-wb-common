...
package org.kie.workbench.common.screens.datasource.management.backend.core.impl.jndi;
...
public class JNDIDataSourceProvider implements DataSourceProvider {
    ...
    public DataSource create( DataSourceDef dataSourceDef ) throws Exception {
        if ( dataSourceDef.getJndi() == null ) {
            throw new Exception( "jndi name for data source is not defined" );
        }
        return new JNDIDataSourceImpl( dataSourceDef.getJndi() );
    }
