...
public interface DataSourceProviderRegistry {
     ...
     */
    void registerProvider( DataSourceProvider dataSourceProvider );

    /**
     * Gets the DataSourceProvider for the given data source type.
     *
     * @return The registered provider for the given type, null if no suitable provider is registered.
     */
