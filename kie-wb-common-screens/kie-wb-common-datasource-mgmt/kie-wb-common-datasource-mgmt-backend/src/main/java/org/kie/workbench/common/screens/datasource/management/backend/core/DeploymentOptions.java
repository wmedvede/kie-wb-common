...
public class DeploymentOptions {
    ...
    enum DeploymentMode { CREATE_DEPLOYMENT, CRATE_OR_RESYNC_DEPOLYMENT }
    ...
    public boolean isCreateOrResyncDeployment() {
        return DeploymentMode.CRATE_OR_RESYNC_DEPOLYMENT.equals( deploymentMode );
    }

    public static DeploymentOptions create() {
        return new DeploymentOptions( DeploymentMode.CREATE_DEPLOYMENT );
    }

    public static DeploymentOptions createOrResync() {
        return new DeploymentOptions( DeploymentMode.CRATE_OR_RESYNC_DEPOLYMENT );
    }
}
