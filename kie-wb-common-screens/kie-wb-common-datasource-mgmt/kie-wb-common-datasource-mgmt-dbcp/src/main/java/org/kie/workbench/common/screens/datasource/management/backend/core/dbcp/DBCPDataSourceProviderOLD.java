...
/**
 * This class implements a DataSourceProviderOLD contract for the CUSTOM type data sources.
 */
@ApplicationScoped
@Named( value = "DBCPDataSourceProviderOLD" )
public class DBCPDataSourceProviderOLD implements DataSourceProviderOLD {
    ...
    public DBCPDataSourceProviderOLD() {
    }
