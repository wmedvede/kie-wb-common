...
public class DataSourceSelector
    ...
    private ParameterizedCommand<DataSourceDefInfo> onSelectCommand;
    ...
    public void show( ParameterizedCommand<DataSourceDefInfo> onSelectCommand, Command onCloseCommand ) {
    ...
    public void onSelect() {
        if ( onSelectCommand != null ) {
            onSelectCommand.execute( view.getSelectedRow().getDataSourceDefInfo() );
        }
    }
