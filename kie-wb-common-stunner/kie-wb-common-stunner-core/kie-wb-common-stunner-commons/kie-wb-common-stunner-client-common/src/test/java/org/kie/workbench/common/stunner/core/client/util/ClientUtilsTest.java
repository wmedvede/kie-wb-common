...
public class ClientUtilsTest {
    ...
    public void testGetSelectedElementUUIDWhenNotSelected() {
        selectedItems.clear();
        assertEquals(null, ClientUtils.getSelectedElementUUID(viewerSession));
        assertEquals(null, ClientUtils.getSelectedElementUUID(editorSession));
    }
    ...
    public void testGetSelectedNodeWhenNotSelected() {
        selectedItems.clear();
        assertEquals(null, ClientUtils.getSelectedNode(diagram, viewerSession));
        assertEquals(null, ClientUtils.getSelectedNode(diagram, editorSession));
    }
}
