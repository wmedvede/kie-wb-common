...
public class WorkItemDefinitionServiceImpl
    ...
    // TODO: Coexitence between designers - who will install the specified service repo?
    // TODO: Supprt for "imoprt-all"?
    ...
    @PostConstruct
    public void init() {
        vfsLookupManager = new VFSLookupManager<WorkItemDefinitions>(ioService)
    ...
    private static class WorkItemDefinitions {

        private final Collection<WorkItemDefinition> definitions;
