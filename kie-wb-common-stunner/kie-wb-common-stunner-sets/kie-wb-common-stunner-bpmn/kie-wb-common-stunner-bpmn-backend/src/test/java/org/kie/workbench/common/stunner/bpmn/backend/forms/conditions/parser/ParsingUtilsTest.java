...
public class ParsingUtilsTest {
    ...
    private void testParseJavaNameFailure(String[] inputs, char[] stopCharacters) throws Exception {
        for (int i = 0; i < inputs.length; i++) {
            try {
                ParsingUtils.parseJavaName(inputs[i], 0, stopCharacters);
                Assert.fail("An exception was expected for input value: " + inputs[i]);
