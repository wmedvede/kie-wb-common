...
/**
 * This class is only intended for validating a Quartz crone expression in client context. Quartz crone expressions are a subset
 * of the unix crone expressions, but there's no specification for this subset. So the code below for making the validation is
 * borrowed from the org.drools.core.time.impl.CronExpression class.
 */
