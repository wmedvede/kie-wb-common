...
public class VariableUtilsTest {
    ...
    private void addInputOutputCollections(List<VariableUsage> expectedResult, String inputCollection, String outputCollection, Node node) {
        if (inputCollection != null) {
            expectedResult.add(new VariableUsage(inputCollection, VariableUsage.USAGE_TYPE.INPUT_COLLECTION, node, NODE_NAME));
        }
        if (outputCollection != null) {
            expectedResult.add(new VariableUsage(outputCollection, VariableUsage.USAGE_TYPE.OUTPUT_COLLECTION, node, NODE_NAME));
        }
    }
