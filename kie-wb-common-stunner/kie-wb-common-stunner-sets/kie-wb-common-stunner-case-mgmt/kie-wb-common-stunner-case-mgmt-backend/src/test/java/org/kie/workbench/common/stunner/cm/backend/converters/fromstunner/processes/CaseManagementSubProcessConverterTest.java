...
public class CaseManagementSubProcessConverterTest {
    ...
    @Before
    public void setup() {
        final DefinitionsBuildingContext context =
                new DefinitionsBuildingContext(new GraphImpl("x", new GraphNodeStoreImpl()),
                                               CaseManagementDiagram.class);

        final CaseManagementPropertyWriterFactory propertyFactory =
                new CaseManagementPropertyWriterFactory();

        final CaseManagementConverterFactory factory =
                new CaseManagementConverterFactory(context, propertyFactory);
