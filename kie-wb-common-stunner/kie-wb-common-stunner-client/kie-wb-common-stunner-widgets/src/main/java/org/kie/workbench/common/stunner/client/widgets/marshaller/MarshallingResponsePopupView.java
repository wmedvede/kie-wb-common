...
public class MarshallingResponsePopupView
    ...
    @Override
    public String displayableValue(Violation.Type type) {
        switch (type) {
            case ERROR:
    ...
    @Override
    public String displayableValue(MarshallingMessage message) {
        return translationService.getValue(message.getMessageKey(), message.getMessageArguments().toArray());
    }
